...
# Collaborator: <Zhong Zhaoping>, <11a>
...
def install_rational_package():
    ...
    def repord_to_reprat(x):
        return (create_ordinary(x),create_ordinary(1)) # Replace this
    ...
    def RRmethod_to_ORmethod(method):
        def convert(ord,rat):
            print(ord,rat)
            return method(repord_to_reprat(ord), rat)
        return convert
...
# output: Boolean      
    ...
    def repord_to_repcom(x):
        return (create_ordinary(x),create_ordinary(0)) # Replace this
